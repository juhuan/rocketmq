...
public class GetMaxOffsetFromSlaveIT extends ContainerIntegrationTestBase {
    ...
    public void testGetMaxOffsetFromSlave() throws InterruptedException, RemotingException, MQClientException, MQBrokerException {
        awaitUntilSlaveOK();
        mqProducer.getDefaultMQProducerImpl().getMqClientInstance().updateTopicRouteInfoFromNameServer(THREE_REPLICAS_TOPIC);
        ...
        mqProducer.getDefaultMQProducerImpl().getMqClientInstance().updateTopicRouteInfoFromNameServer(THREE_REPLICAS_TOPIC);
        assertThat(mqProducer.getDefaultMQProducerImpl().getMqClientInstance().findBrokerAddressInPublish(
