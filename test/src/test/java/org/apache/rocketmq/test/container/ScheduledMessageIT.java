...
public class ScheduledMessageIT extends ContainerIntegrationTestBase {
    ...
    public void consumeScheduledMsgFromSlave() throws MQClientException, RemotingException, InterruptedException, MQBrokerException {
        ...
        producer.getDefaultMQProducerImpl().getMqClientInstance().updateTopicRouteInfoFromNameServer(topic);
        assertThat(producer.getDefaultMQProducerImpl().getMqClientInstance().findBrokerAddressInPublish(topic)).isNull();
